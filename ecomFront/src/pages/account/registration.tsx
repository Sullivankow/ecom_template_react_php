        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 py-2 rounded-md bg-blue-600 hover:bg-blue-700 transition border border-blue-600" aria-label="S'inscrire avec Google">
                {/* Icône Google */}
